...
pub fn block_header() -> BlockHeader {
    ...
    let genesis_hash =
        hex::decode("8fcf233671b6a04fcf679d2a381c2544ea6c1ea29ba6157776ed8424bbcacb48").unwrap();
    ...
    let context_hash =
        hex::decode("fc73e5a7e0733387f86ad1b704121b81835c9a510a529ed96ecb9c34b732231b").unwrap();
